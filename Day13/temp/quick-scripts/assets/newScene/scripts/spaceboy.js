(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/newScene/scripts/spaceboy.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        this.animation.setAnimation(0, 'idle', true);
        this.animation.setInterruptListener(function () {
    ...
    update: function update(dt) {
        ...
        if (!this._moving) {
            this.animation.setAnimation(0, 'idle', true);
            this.animation.setStartListener(function () {
