"use strict";
cc._RF.push(module, '456b4QpOixHcbqvOBB9Sq2E', 'project');
...
window.__require = function n(t, i, o) {
  function e(a, s) {
    ...
    "use strict";
    cc._RF.push(module, "ec34fzgy0dKPq9njdd2/xaM", "30easeScript"), cc.Class({ extends: cc.Component, properties: { object: cc.Node, action: null }, onClick: function onClick(event, message) {
    ...
    "use strict";
    cc._RF.push(t, "280c3rsZJJKnZ9RqbALVwtK", "HelloWorld"), cc.Class({ extends: cc.Component, properties: { label: { default: null, type: cc.Label }, text: "Hello, World!" }, onLoad: function onLoad() {
        this.label.string = this.text;
      }, update: function update(n) {} }), cc._RF.pop();
  }, {}], animationScript: [function (n, t, i) {
    "use strict";
    cc._RF.push(t, "cae8822MO5AQZar4yzRJbMO", "animationScript"), cc.Class({ extends: cc.Component, properties: { animation: sp.Skeleton }, onLoad: function onLoad() {
