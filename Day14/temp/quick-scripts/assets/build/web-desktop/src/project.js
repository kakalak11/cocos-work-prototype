(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/build/web-desktop/src/project.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '83517Vmu01Mv6DkJsylAzra', 'project', __filename);
...
window.__require = function n(t, i, o) {
  function e(s, a) {
    ...
    "use strict";
    cc._RF.push(t, "90440okT1VCjrScS70TgRZv", "bullet", __filename), cc.Class({ extends: cc.Component, properties: { _direction: null, _speed: 1e3 }, onLoad: function onLoad() {}, start: function start() {}, update: function update(n) {
        this.node.x += this._speed, cc.log("bullet flying");
      } }), cc._RF.pop();
  }, {}], objectFalling: [function (n, t, i) {
    "use strict";
    cc._RF.push(t, "da4420NSyZPDK+3Kt/hlibQ", "objectFalling", __filename), cc.Class({ extends: cc.Component, properties: {}, onCollisionEnter: function onCollisionEnter(n, t) {
    ...
    "use strict";
    cc._RF.push(t, "88b9frFMkRF4ZI9LNqbfOwK", "spaceboy", __filename), cc.Class({ extends: cc.Component, properties: { _animating: !1, _moving: null, _direction: 1, _canShoot: null, bulletPrefab: cc.Prefab }, _jump: function _jump() {
