"use strict";
cc._RF.push(module, '12da2iy1h1AbKi/yMbqmaHT', 'project');
...
window.__require = function e(t, s, i) {
  function n(a, c) {
    ...
    "use strict";
    cc._RF.push(t, "18d42ASHGtASa+Y39j+2P2l", "mainForm");var i = e("utils");cc.Class({ extends: cc.Component, properties: { userNameBox: cc.EditBox, userNameMessage: cc.Node, emailBox: cc.EditBox, emailMessage: cc.Node, passWordBox: cc.EditBox, passWordMessage: cc.Node, confirmBox: cc.EditBox, confirmMessage: cc.Node, signUpButton: cc.Button, congratulation: cc.Node, congratulationLabel: cc.RichText, list: cc.Node, listContent: cc.Node, listPrefab: cc.Prefab, _checkingUserName: null, _checkingEmail: null, _checkingPassWord: null, _checkingConfirm: null, _userNameList: [] }, onUserNameInputBegan: function onUserNameInputBegan() {
    ...
    "use strict";
    cc._RF.push(t, "d94adBbLD5NNa7TtzbbJSCy", "utils"), console.log("Utilities");var i = { check: function check() {
