(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Animation/web-desktop/src/project.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'aeb9algafBImbEur+PlES/p', 'project', __filename);
...
window.__require = function n(t, i, o) {
  function e(c, a) {
    ...
    "use strict";
    cc._RF.push(t, "56d0eMh5kBHYpMohrYyFB0S", "animationScript", __filename), cc.Class({ extends: cc.Component, properties: { animation: sp.Skeleton, footstepSound: cc.AudioSource }, _onKeyDown: function _onKeyDown(n) {
